  ...
  return (
    <>
      <h1 className="mt-14 font-display text-4xl/tight font-bold text-white">
        Las mejores noticias y recursos en
        <span className="text-yellow-300"> programación web.</span>
      </h1>
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-1 text-[0.8125rem]/6 text-gray-500">
      Sígueme en{' '}
      <IconLink
